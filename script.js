...
const rotorMap = "EKMFLGDQVZNTOWYHXUSPAIBRCJ".split("");
const reflektorMap = "YRUHQSLDPXNGOKMIEBFZCWVJAT".split("");
 ...
 * @param {string} text Vstupní text k zašifrování.
 ...
 * @param {string} text Vstupní text k zašifrování nebo dešifrování.
 * @returns {string} Zašifrovaný nebo dešifrovaný text.
 */
...
resetRotor();
const desifrovanaVeta = enigma(sifrovanaVeta);
console.log(`Dešifrování věty: "${sifrovanaVeta}" -> "${desifrovanaVeta}"`);
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const staticEncryptBtn = document.getElementById("static-encrypt-btn");
    ...
    const enigmaProcessBtn = document.getElementById("enigma-process-btn");
    const enigmaResetBtn = document.getElementById("enigma-reset-btn");
